...
describe('screener-storybook/src/validate', function() {
  describe('validate.storybookConfig', function() {
    ...
    it('should allow adding optional fields', function() {
      return validate.storybookConfig({apiKey: 'key', projectRepo: 'repo', storybookConfigDir: '.storybook', storybookStaticDir: './public', storybookPort: 6006, storybook: [], build: 'build', branch: 'branch', commit: 'commit', resolution: '1280x1024', cssAnimations: true, ignore: 'ignore', includeRules: [], excludeRules: [], initialBaselineBranch: 'master', diffOptions: {}})
        .catch(function() {
          throw new Error('Should not be here');
        });
    });
